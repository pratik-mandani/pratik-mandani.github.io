...
export function Journey() {
  return (
    <section id="journey" className="py-14 sm:py-20 border-b border-slate-200 bg-[#F8FAFC]">
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
        ...
        <div className="relative">
          ...
          <div className="block md:hidden absolute top-3 bottom-3 left-[15px] sm:left-[19px] w-[2px] bg-blue-200 z-0"></div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 relative z-10">
            {journeyStages.map((stage) => {
              ...
              return (
                <div key={stage.stageNumber} className="relative flex flex-col pl-11 sm:pl-14 md:pl-0">
                  
                  {/* Timeline Node Marker */}
                  <div className="absolute left-0 md:relative md:left-auto flex items-center md:justify-center mb-3">
                    <div className="w-8 h-8 sm:w-10 sm:h-10 rounded-full bg-white border-2 border-blue-600 flex items-center justify-center shadow-xs">
                      <span className="w-2.5 h-2.5 sm:w-3.5 sm:h-3.5 rounded-full bg-blue-600"></span>
                    </div>
                  </div>

                  {/* Stage Card */}
                  <div className="p-4 sm:p-6 rounded-2xl border border-slate-200 bg-white shadow-2xs hover:border-blue-300 hover:shadow-xs transition-all flex-1 flex flex-col justify-between">
                    <div>
                      {/* Period Badge */}
