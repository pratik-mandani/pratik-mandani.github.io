...
export function Resume() {
  return (
    <section id="resume" className="py-16 sm:py-20 border-b border-slate-200 bg-white">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 text-center">
        ...
        <div className="flex flex-wrap items-center justify-center gap-3">
          <a
            ...
            className="inline-flex items-center gap-2 px-6 py-2.5 rounded text-sm font-semibold bg-blue-600 hover:bg-blue-700 text-white transition-colors shadow-xs"
          >
          ...
          <a
            ...
            className="inline-flex items-center gap-2 px-6 py-2.5 rounded text-sm font-semibold bg-slate-100 hover:bg-slate-200 text-slate-800 border border-slate-300 transition-colors"
          >
