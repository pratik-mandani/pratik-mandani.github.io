    ...
    <section id="hero" className="py-12 sm:py-16 md:py-20 border-b border-slate-200/80 dark:border-slate-800 bg-white dark:bg-slate-900 transition-colors">
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
        <div className="flex flex-col lg:flex-row items-center lg:items-start gap-8 lg:gap-12">
          {/* Left Column: Photo / Avatar with rounded card and soft glow */}
          <div className="flex-shrink-0 flex flex-col items-center">
            <div className="relative group">
              <div className="w-56 h-56 sm:w-64 sm:h-64 lg:w-72 lg:h-72 rounded-2xl overflow-hidden border-2 border-slate-200 dark:border-slate-700 shadow-lg shadow-blue-500/5 bg-slate-100 dark:bg-slate-800">
                <img
                  src="https://avatars.githubusercontent.com/u/81868134?v=4"
                  alt="Pratik Mandani"
            ...
            <div className="mt-4 flex flex-col items-center text-xs text-slate-500 dark:text-slate-400 gap-1 text-center">
              ...
              <span>Available for Technical Discussions</span>
            </div>
          </div>
          ...
          <div className="flex-1 flex flex-col items-center lg:items-start text-center lg:text-left">
            {/* Status Pill */}
            <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full text-xs font-semibold uppercase tracking-wider text-emerald-800 dark:text-emerald-300 bg-emerald-50 dark:bg-emerald-950/40 border border-emerald-300/60 dark:border-emerald-800/60 mb-3 shadow-xs">
              <span className="w-2 h-2 rounded-full bg-emerald-500 animate-pulse"></span>
              <span>Currently at Altius Infoway</span>
            </div>

            {/* Name */}
            <h1 className="text-3xl sm:text-4xl lg:text-5xl font-extrabold tracking-tight text-slate-900 dark:text-white mb-2 leading-tight">
              <span className="hero-gradient-text">Pratik Mandani</span>
            </h1>

            {/* Animated Typing Title */}
            <div className="text-base sm:text-xl font-bold text-blue-700 dark:text-blue-400 h-7 mb-3 flex items-center justify-center lg:justify-start">
              <span>{displayText}</span>
              <span className="inline-block w-0.5 h-5 ml-1 bg-blue-600 dark:bg-blue-400 animate-pulse"></span>
            </div>

            {/* Sub-headline */}
            <p className="text-sm sm:text-base font-semibold text-slate-700 dark:text-slate-200 mb-3 max-w-2xl">
            ...
            {/* Bio Paragraph */}
            <p className="text-xs sm:text-sm text-slate-600 dark:text-slate-300 leading-relaxed max-w-2xl mb-6">
